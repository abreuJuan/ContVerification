                                                                ...
                                                                <tr style="border-collapse: collapse;">
                                                                    <td align="left" style="padding: 0; margin: 0; padding-bottom: 5px; padding-top: 20px;">
                                                                        ...
                                                                        >
																			...
																			{!! Form::open(["route" => "solicitud.cambiar_condicion", "id" => "solicitudForm"]) !!}
																			<br/>
																			 <div style="width:50%">
																			   ...
																			   style="padding:10px;width:100%;">
																				   ...
																				   <option value="Verificación y despacho">Verificación y despacho</option>
																			   ...
																			   background-color: green;border-color: green;border-style:none;">
																			     Si, Cambiar
																			   </button>
