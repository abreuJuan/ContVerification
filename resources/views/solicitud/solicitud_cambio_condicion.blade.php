                            ...
                            <tr style="border-collapse: collapse;">
                                <td align="center" style="padding: 0; margin: 0;">
                                    <table
                                        ...
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; border-collapse: collapse; border-spacing: 0px; background-color: #0A3C71; width: 600px;"
                                        cellspacing="0"
                                        cellpadding="0"
                                        bgcolor="#0A3C71"
                                        align="center"
                                                                ...
                                                                <tr style="border-collapse: collapse;">
                                                                    <td class="es-m-txt-c" align="center" style="padding: 0; margin: 0;">
                                                                        <h1
                                                                            ...
                                                                            "
                                                                        >
                                                                            Editar condici&oacute;n de la solicitud
                                                                        </h1>
                                                                    </td>
                                                                </tr>
                                                            </table>
                                                                ...
                                                                <tr style="border-collapse: collapse;">
                                                                    <td align="left" style="padding: 0; margin: 0; padding-bottom: 5px; padding-top: 20px;">
                                                                        <h3
                                                                            ...
                                                                            "
                                                                        >
                                                                            Selecione la condici&oacute;n a cambiar:
                                                                        </h3>
                                                                        <p
                                                                            style="
                                                                                margin: 0;
                                                                        ...
                                                                        >
																			...
																			{!! Form::open(["route" => "solicitud.cambiar_condicion", "id" => "solicitudForm","onsubmit" => "return false"]) !!}
																			<br/>
																			 <div style="width:50%">
                                                                                 {{ csrf_token() }}
																			   ...
																			   <select id="condicion" name="condicion" placeholder="Seleccione una opción"
																			   style="padding:10px;width:100%;">
																			       <option value=""></option>
                                                                                    @if( $solicitud->condicion != 'Verificación' )
																			         <option value="Verificación" selected>Verificación</option>
                                                                                    @endif
                                                                                                                                                               
                                                                                    @if( $solicitud->condicion != 'Verificación y despacho' )
																				     <option value="Verificación y despacho" selected>Verificación y despacho</option>
                                                                                    @endif
																			   </select>
																			   ...
																			   <button style="padding:15px;color:white;font-weight:bold;
																			   background-color: green;border-color: green;border-style:none;" onclick="submitValidate()">
																			     Si, Cambiar
																			   </button>
