     ...
     <div class="row">
        <div class="col-md-12">
             <div class="alert alert-success">
                <h4>
                  La solicitud de acceso a la zona ha sido actualizada exitosamente.
                  Ahora tienes la opción de modificar o ver la solicitud en cualquier momento
                   a través del enlace enviado previamente a su correo electrónico o haciendo clic en el siguiente enlace 
                   <a href="{{ route("solicitud.acceso_zona_verificacion",$hash) }}">Ver solicitud</a>
                </h4>
             </div>
        </div>
